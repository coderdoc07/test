...
public class GuitarString {
    ...
    public GuitarString(double frequency) {
        ...
        /** Here we are creating an ArrayRingBuffer with the capacity even though
         *  buffer was instantiated as an BoundedQueue and that's because ArrayRingBuffer
    ...
    public void tic() {
        ...
        this.buffer.enqueue(average * DECAY);
    }
